...
REM
REM SDR note: from a source checkout SoapySDR is unavailable, so src/main.py
REM borrows the SoapySDR bundle from an installed FBSAT59 build if one exists
REM (see the non-frozen Windows block there).  Nothing to do here.
REM
